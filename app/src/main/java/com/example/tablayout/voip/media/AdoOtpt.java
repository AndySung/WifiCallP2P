...
import com.example.tablayout.voip.Ado.AdoWavfm;
...
public class AdoOtpt //音频输出。
{
    ...
    public class Strm //存放流。
    {
        ...
        {
            public com.example.tablayout.voip.Ado.SpeexDecd m_Pt; //存放指针。
            ...
            Out:
            {
                ...
                switch( m_UseWhatDecd )
                {
                    ...
                    case 1: //如果要使用Speex解码器。
                    {
                        ...
                        m_SpeexDecdPt.m_Pt = new com.example.tablayout.voip.Ado.SpeexDecd();
