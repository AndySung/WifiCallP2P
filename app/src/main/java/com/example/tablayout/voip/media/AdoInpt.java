package com.example.tablayout.voip.media;
...
import com.example.tablayout.voip.Ado.*;
...
public class AdoInpt //存放音频输入。
{
    ...
    {
        com.example.tablayout.voip.Ado.SpeexAec m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.WebRtcAecm m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.WebRtcAec m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.SpeexWebRtcAec m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.WebRtcNsx m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.WebRtcNs m_Pt; //存放指针。
        int m_PolicyMode; //存放策略模式，策略模式越高抑制越强，取值区间为[0,3]。
    }
    ...
    {
        com.example.tablayout.voip.Ado.RNNoise m_Pt; //存放指针。
    }
    ...
    class SpeexPrpocs
    {
        ...
        com.example.tablayout.voip.Ado.SpeexPrpocs m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Ado.SpeexEncd m_Pt; //存放指针。
    ...
    class WaveFileWriter //存放Wave文件写入器。
    {
        ...
        com.example.tablayout.voip.media.WaveFileWriter m_SrcPt; //存放原始的指针。

        com.example.tablayout.voip.media.WaveFileWriter m_RsltPt; //存放结果的指针。
        ...
        Out:
        {
            switch( m_UseWhatAec )
            {
                ...
                case 1: //如果要使用Speex声学回音消除器。
                {
                    ...
                    {
                        m_SpeexAecPt.m_Pt = new com.example.tablayout.voip.Ado.SpeexAec();
                ...
                {
                    m_WebRtcAecmPt.m_Pt = new com.example.tablayout.voip.Ado.WebRtcAecm();
                ...
                case 3: //如果要使用WebRtc浮点版声学回音消除器。
                {
                    ...
                    {
                        m_WebRtcAecPt.m_Pt = new com.example.tablayout.voip.Ado.WebRtcAec();
                ...
                {
                    m_SpeexWebRtcAecPt.m_Pt = new com.example.tablayout.voip.Ado.SpeexWebRtcAec();
    ...
    public int NsInit()
    {
        ...
        Out:
        {
            switch( m_UseWhatNs )
            {
                ...
                {
                    m_WebRtcNsxPt.m_Pt = new com.example.tablayout.voip.Ado.WebRtcNsx();
                ...
                {
                    m_WebRtcNsPt.m_Pt = new com.example.tablayout.voip.Ado.WebRtcNs();
                ...
                {
                    m_RNNoisePt.m_Pt = new com.example.tablayout.voip.Ado.RNNoise();
    ...
    public int SpeexPrpocsInit()
    {
        ...
        Out:
        {
            ...
            {
                m_SpeexPrpocsPt.m_Pt = new com.example.tablayout.voip.Ado.SpeexPrpocs();
        ...
        Out:
        {
            switch( m_UseWhatEncd )
            {
                ...
                case 1: //如果要使用Speex编码器。
                {
                    ...
                    m_SpeexEncdPt.m_Pt = new com.example.tablayout.voip.Ado.SpeexEncd();
    ...
    public int WaveFileWriterInit()
    {
        ...
        Out:
        {
            ...
            {
                m_WaveFileWriterPt.m_SrcPt = new com.example.tablayout.voip.media.WaveFileWriter();
                ...
                m_WaveFileWriterPt.m_RsltPt = new com.example.tablayout.voip.media.WaveFileWriter();
