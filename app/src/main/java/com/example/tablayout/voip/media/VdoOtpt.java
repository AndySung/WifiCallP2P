...
import com.example.tablayout.voip.Vdo.*;
...
public class VdoOtpt //视频输出。
{
    ...
    public class Strm //存放流。
    {
        ...
        {
            com.example.tablayout.voip.Vdo.OpenH264Decd m_Pt; //存放指针。
        ...
        {
            com.example.tablayout.voip.Vdo.SystemH264Decd m_Pt; //存放指针。
        }
        ...
        public int DecdInit()
        {
            ...
            Out:
            {
                switch( m_UseWhatDecd )
                {
                    ...
                    {
                        m_OpenH264DecdPt.m_Pt = new com.example.tablayout.voip.Vdo.OpenH264Decd();
                    ...
                    {
                        m_SystemH264DecdPt.m_Pt = new com.example.tablayout.voip.Vdo.SystemH264Decd();
