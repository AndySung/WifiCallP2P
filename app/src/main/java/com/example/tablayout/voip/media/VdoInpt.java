...
import com.example.tablayout.voip.Vdo.LibYUV;
...
public class VdoInpt //视频输入。
{
    ...
    class OpenH264Encd //存放OpenH264编码器。
    {
        ...
        com.example.tablayout.voip.Vdo.OpenH264Encd m_Pt; //存放指针。
    ...
    {
        com.example.tablayout.voip.Vdo.SystemH264Encd m_Pt; //存放指针。
        int m_EncdBitrate; //存放编码后比特率，单位为bps。
    ...
    int Init()
    {
        ...
        Out:
        {
            ...
            switch( m_UseWhatEncd )
            {
                ...
                {
                    m_OpenH264EncdPt.m_Pt = new com.example.tablayout.voip.Vdo.OpenH264Encd();
                ...
                {
                    m_SystemH264EncdPt.m_Pt = new com.example.tablayout.voip.Vdo.SystemH264Encd();
