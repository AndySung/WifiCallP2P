...
public class FrgndSrvc extends Service
{
    ...
    {
        public void SetForeground( ConfigVoIPActivity MainActivityPt )
        {
            ...
            //创建通知。
            PendingIntent pendingIntent = PendingIntent.getActivity( m_MainActivityPt, 0, new Intent( m_MainActivityPt, ConfigVoIPActivity.class ), PendingIntent.FLAG_IMMUTABLE );
            Notification notification =
                    new NotificationCompat
                            ...
                            .setSmallIcon( R.mipmap.wificall_app_icon )
    ...
    @Nullable
    @Override public IBinder onBind(Intent intent ) //本服务被绑定。
    {
