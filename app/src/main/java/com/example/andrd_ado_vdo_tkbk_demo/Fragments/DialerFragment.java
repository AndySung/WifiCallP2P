...
import com.example.andrd_ado_vdo_tkbk_demo.adapter.AddActionAdapter;
import com.example.andrd_ado_vdo_tkbk_demo.adapter.CallLogEntity;
import com.example.andrd_ado_vdo_tkbk_demo.adapter.CallLogListAdapter;
import com.example.andrd_ado_vdo_tkbk_demo.adapter.ContactListAdapter;
import com.example.andrd_ado_vdo_tkbk_demo.utils.Constant;
import com.example.andrd_ado_vdo_tkbk_demo.utils.ContactsUtil;
import com.example.andrd_ado_vdo_tkbk_demo.utils.SharedPrefsUtil;
import com.example.andrd_ado_vdo_tkbk_demo.utils.SkinManager;
...
//					}
		...
		dialAddContacts = (ImageButton) parent
				.findViewById(R.id.dial_num_dian);
//		dialAddContacts.setEnabled(false);
...
//				}
	...
	public void onClick(View v) {
		if(v.getId() == R.id.dial_num_1) {
			playTone(1);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_2) {
			playTone(2);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_3) {
			playTone(3);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_4) {
			playTone(4);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_5) {
			playTone(5);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_6) {
			playTone(6);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_7) {
			playTone(7);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_8) {
			playTone(8);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_9) {
			playTone(9);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_star) {
			playTone(10);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_0) {
			playTone(0);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_dian) {
			playTone(0);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_num_pound) {
			playTone(11);
			input(v.getTag().toString());
		}else if(v.getId() == R.id.dial_call) {
		...
		}else if(v.getId() == R.id.dial_delete) {
			delete();
		}
//		switch (v.getId()) {
...
//	};
	...
	private void input(String str) {
		...
		if ("*#06#".equals(numInputView.getText().toString())) {
			...
			Builder imeiDialog = new Builder(
					getActivity());
